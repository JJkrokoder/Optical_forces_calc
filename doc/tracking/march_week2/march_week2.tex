...
of the project has been analyzed. A problem with the git
repository opening in VSCode has been detected, but no
solution has been found yet. When the repository is opened
within the VSCode SSH connection, the `code` command doesn't
work in the remote terminal.
